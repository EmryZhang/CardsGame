System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1c638Pmpe5MargqnRfRmUg0", "LevelController_bak", undefined);
      ...
      _export("default", LevelController = (_dec = ccclass('LevelController'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([SpriteFrame]), _dec6 = property([SpriteFrame]), _dec7 = property([SpriteFrame]), _dec8 = property([SpriteFrame]), _dec9 = property([SpriteFrame]), _dec(_class = (_class2 = class LevelController extends Component {
        ...
        createCardsFromConfig() {
          ...
          const totalHandCards = ((_this$levelConfig$Sta = this.levelConfig.Stack) == null ? void 0 : _this$levelConfig$Sta.length) || 0;
        ...
        createTableCard(config, index, layoutConfig) {
          ...
          let posY = config.Position.y; // 简单的向下微调，防止卡牌超出屏幕上边缘
        ...
        setupHandCardPosition(cardNode, index, layoutConfig, totalCards) {
          ...
          const separateY = (_ref4 = (_handConf$separateCar2 = handConf.separateCardY) != null ? _handConf$separateCar2 : handConf.separateCardY) != null ? _ref4 : startY;
          let posX = 0;
          let posY = startY;
        ...
        setupCardDisplay(cardNode, config, area, index) {
          const isRed = this.isRedSuit(config.CardSuit); // 辅助函数：安全设置图片
...
//# sourceMappingURL=9d4283a157b943b51a971ebaebce7b606cba5010.js.map